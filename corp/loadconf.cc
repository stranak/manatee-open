...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    KW_ATTRIBUTE = 258,            /* KW_ATTRIBUTE  */
    KW_STRUCTURE = 259,            /* KW_STRUCTURE  */
    KW_PROCESS = 260,              /* KW_PROCESS  */
    KW_AT = 261,                   /* KW_AT  */
    LBRACE = 262,                  /* LBRACE  */
    RBRACE = 263,                  /* RBRACE  */
    PATH = 264,                    /* PATH  */
    ...
    STR = 266,                     /* STR  */
    NL = 267,                      /* NL  */
    BISON_OLD_ERR = 268            /* BISON_OLD_ERR  */
  };
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_KW_ATTRIBUTE = 3,               /* KW_ATTRIBUTE  */
  YYSYMBOL_KW_STRUCTURE = 4,               /* KW_STRUCTURE  */
  YYSYMBOL_KW_PROCESS = 5,                 /* KW_PROCESS  */
  YYSYMBOL_KW_AT = 6,                      /* KW_AT  */
  YYSYMBOL_LBRACE = 7,                     /* LBRACE  */
  YYSYMBOL_RBRACE = 8,                     /* RBRACE  */
  YYSYMBOL_PATH = 9,                       /* PATH  */
  YYSYMBOL_ATTR = 10,                      /* ATTR  */
  YYSYMBOL_STR = 11,                       /* STR  */
  YYSYMBOL_NL = 12,                        /* NL  */
  YYSYMBOL_BISON_OLD_ERR = 13,             /* BISON_OLD_ERR  */
  YYSYMBOL_YYACCEPT = 14,                  /* $accept  */
  YYSYMBOL_config = 15,                    /* config  */
  YYSYMBOL_16_1 = 16,                      /* $@1  */
  YYSYMBOL_block = 17,                     /* block  */
  YYSYMBOL_statement = 18,                 /* statement  */
  YYSYMBOL_outerBlock = 19,                /* outerBlock  */
...
{
       0,    92,    92,    92,    98,   100,   101,   102,   106,   112,
     118,   127,   135,   136,   140,   146,   150,   154,   158
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "KW_ATTRIBUTE",
  "KW_STRUCTURE", "KW_PROCESS", "KW_AT", "LBRACE", "RBRACE", "PATH",
  "ATTR", "STR", "NL", "BISON_OLD_ERR", "$accept", "config", "$@1",
  "block", "statement", "outerBlock", "line", "value", YY_NULLPTR
};
...
{
     -10,     3,    17,   -10,   -10,    32,    32,    32,    32,     1,
     -10,     0,     5,    -4,     6,   -10,   -10,   -10,   -10,   -10,
     -10,   -10,    -2,     1,   -10,    27,   -10,    11,   -10
};
...
{
       2,     0,     0,     1,    15,     0,     0,     0,     0,     0,
       3,    12,     0,     5,     0,    16,    17,     8,     9,    10,
      14,     7,     0,     0,    18,     0,     6,     0,    13
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -10,   -10,   -10,    -9,   -10,   -10,   -10,    18
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     1,     2,    10,    11,    12,    13,    17
};
...
{
      21,    -4,     4,     3,     5,     6,     7,   -11,    23,    -4,
      25,     8,    22,     9,    26,    24,    27,    -4,     4,    28,
       5,     6,     7,     0,    18,    19,    20,     8,     4,     9,
       5,     6,     7,     0,     0,    -4,     0,     8,    14,     9,
       0,    15,     0,    16
};

static const yytype_int8 yycheck[] =
{
       9,     0,     1,     0,     3,     4,     5,     7,    12,     8,
      12,    10,     7,    12,    23,     9,    25,     0,     1,     8,
       3,     4,     5,    -1,     6,     7,     8,    10,     1,    12,
       3,     4,     5,    -1,    -1,     8,    -1,    10,     6,    12,
      -1,     9,    -1,    11
};
...
{
       0,    15,    16,     0,     1,     3,     4,     5,    10,    12,
      17,    18,    19,    20,     6,     9,    11,    21,    21,    21,
      21,    17,     7,    12,     9,    12,    17,    17,     8
};

/* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
static const yytype_int8 yyr1[] =
{
       0,    14,    16,    15,    17,    17,    17,    17,    18,    18,
...
#line 85 "corpconf.y"
            { delete[] ((*yyvaluep).val); }
#line 1218 "loadconf.cc"
        break;

    case YYSYMBOL_ATTR: /* ATTR  */
#line 85 "corpconf.y"
            { delete[] ((*yyvaluep).val); }
#line 1224 "loadconf.cc"
        break;

    case YYSYMBOL_STR: /* STR  */
#line 85 "corpconf.y"
            { delete[] ((*yyvaluep).val); }
#line 1230 "loadconf.cc"
        break;

    case YYSYMBOL_statement: /* statement  */
#line 84 "corpconf.y"
            { delete ((*yyvaluep).ci); }
#line 1236 "loadconf.cc"
        break;

    case YYSYMBOL_outerBlock: /* outerBlock  */
#line 84 "corpconf.y"
            { delete ((*yyvaluep).ci); }
#line 1242 "loadconf.cc"
        break;

    case YYSYMBOL_value: /* value  */
#line 85 "corpconf.y"
            { delete[] ((*yyvaluep).val); }
#line 1248 "loadconf.cc"
        break;
...
#line 1523 "loadconf.cc"
    break;

  case 8: /* statement: KW_ATTRIBUTE value  */
#line 107 "corpconf.y"
    {
        (yyval.ci) = new CorpInfo();
        result->attrs.push_back (std::pair<std::string,CorpInfo*>((yyvsp[0].val), (yyval.ci)));
        delete [] (yyvsp[0].val);
    }
#line 1533 "loadconf.cc"
    break;

  case 9: /* statement: KW_STRUCTURE value  */
#line 113 "corpconf.y"
    {
        (yyval.ci) = new CorpInfo();
        result->structs.push_back (std::pair<std::string,CorpInfo*>((yyvsp[0].val), (yyval.ci)));
        delete [] (yyvsp[0].val);
    }
#line 1543 "loadconf.cc"
    break;

  case 10: /* statement: KW_PROCESS value  */
#line 119 "corpconf.y"
    {
        (yyval.ci) = new CorpInfo();
        result->procs.push_back (std::pair<std::string,CorpInfo*>((yyvsp[0].val), (yyval.ci)));
        delete [] (yyvsp[0].val);
    }
#line 1553 "loadconf.cc"
    break;

  case 11: /* outerBlock: statement  */
#line 128 "corpconf.y"
    {
        (yyval.ci) = result;
        result = (yyvsp[0].ci);
    }
#line 1562 "loadconf.cc"
    break;

  case 13: /* line: outerBlock LBRACE NL block RBRACE  */
#line 137 "corpconf.y"
    {
        result = (yyvsp[-4].ci);
    }
#line 1570 "loadconf.cc"
    break;

  case 14: /* line: ATTR value  */
#line 141 "corpconf.y"
    {
        result->opts[(yyvsp[-1].val)] = (yyvsp[0].val);
        delete [] (yyvsp[-1].val);
        delete [] (yyvsp[0].val);
    }
#line 1580 "loadconf.cc"
    break;
...
#line 1596 "loadconf.cc"
    break;

  case 18: /* value: KW_AT PATH  */
#line 159 "corpconf.y"
    {
        char* c = new char[strlen((yyvsp[0].val))+2];
        c[0] = '@';
        c[1] = '\0';
        strcat(c, (yyvsp[0].val));
        delete [] (yyvsp[0].val);
        (yyval.val) = c;//"@" + $2;
    }
#line 1609 "loadconf.cc"
    break;


#line 1613 "loadconf.cc"
